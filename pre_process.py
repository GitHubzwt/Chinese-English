...
def extract_valid_data():
    ...
    with open(valid_translation_path, 'r', encoding='utf-8') as f:
        data_en = f.readlines()
    data_en = [line.replace(' & ', ' &amp; ') for line in data_en]
    with open(valid_translation_path, 'w', encoding='utf-8') as f:
    ...
    with open(os.path.join(valid_translation_folder, 'valid.en'), 'w', encoding='utf-8') as out_file:
        out_file.write('\n'.join(data_en) + '\n')
    ...
    with open(os.path.join(valid_translation_folder, 'valid.zh'), 'w', encoding='utf-8') as out_file:
        out_file.write('\n'.join(data_zh) + '\n')
...
def build_samples():
    ...
    for usage in ['train', 'valid']:
        ...
        with open(translation_path_en, 'r', encoding='utf-8') as f:
            data_en = f.readlines()

        with open(translation_path_zh, 'r', encoding='utf-8') as f:
            data_zh = f.readlines()
